...
module PagesHelper
  ...
  def mobile_detect
      "if(jQuery.browser.mobile) {
          ...
          alert (getCookie('user_action'));
          jQuery('#site').append('<div id=\"dialog\"  title=\"Whistler Golf Club\">You are accessing this webiste with a mobile device. What would you like to do ?</div>');
          ...
          jQuery('#dialog').dialog({
            ...
            width: 260,
            buttons: {
              'See the mobile version': function() { 
                window.location='http://m.whistlergolf.com';
              }, 
